...
riscv64-unknown-elf-gcc -march=rv32i -mabi=ilp32 -static -ffunction-sections -mcmodel=medany -ffreestanding -fvisibility=hidden -nostdlib -nostartfiles $OPT -g -Tscripts/baremetal_link.ld -Wl,--no-relax $1 && \
